...
void F (const gsl_vector *V, void *null, gsl_vector *df, Rf_params *params)
  {
  switch (*params->flag)
    {
    case 0: 
      gr_KL_V_xi_n(V,NULL,df, params);
      break;
    case 6: 
      gr_KL_V_xi_e(V,NULL,df, params);
      break;
    case 1: 
      gr_KL_V_z_i(V,NULL,df, params);
      break;
    case 2: 
      gr_KL_V_sigma2_i(V,NULL,df, params);
      break;
    case 3: 
      gr_KL_V_alpha_g(V,NULL,df, params);
      break;
    case 4: 
      gr_KL_V_nu_g(V,NULL,df, params);
      break;
    case 5: 
      gr_KL_V_psi2_n(V,NULL,df, params);
      break;
    case 7: 
      gr_KL_V_psi2_e(V,NULL,df, params);
      break;
    default: 
      break;
    }
...
void bb(double *lim, double *tol, Rf_params *params)
{
  size_t iter = 0; 
